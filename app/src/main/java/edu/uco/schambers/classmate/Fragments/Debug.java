...
public class Debug extends Fragment
{
    ...
    private void setOnClickListeners()
    {
        ...
        mosaBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Fragment studentAttendance = StudentAttendance.newInstance("test","test");
                launchFragment(studentAttendance);
            }
        });
        ...
        rayanBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Fragment teacherAttendance = TeacherAttendance.newInstance("test","test");
                launchFragment(teacherAttendance);
            }
        });
    }
